...
<body>
    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                소통공간<br>
                <span style="font-size:small;">복지관소식</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
        <div class="a_title">
            ...
            line-height:40px;height:40px" onclick="location.href='d4_add.php'">추가하기</div>
            <?php  } }?>
        </div>
       <div id="a2_content">
        <div id="d3_wrap" style="width: 1050px;">
            <?php
            $sql="select * from hanam_d4";
            ...
            <div class="content3_box">
                <div class="content3_img">
                    ...
                    <a href="d4_content.php?no=<?php echo $row["no"]?>">
                        <img src="<?php echo $fname ?>" style="width:340px">
                    </a>
                </div>
