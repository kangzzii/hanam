...
<body>
    ...
    <div id="space_main">
        ...
        <div class="space_mainT">
            생계 , 주거 , 의료 , 교육 등 복합적인 어려움을 가진<br> 지역주민과 그 가족에게<br>
            지역사회자원을 개발하고 연계함으로써<br> 문제 해결을 돕고 자립을 지원합니다
        </div>
    </div>
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title">
                사업안내<br>
                <span style="font-size:small;">사례관리기능</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
        ...
        <div class="a_content">
            <span style="font-size:1.1em;font-weight: bold;">
                ...
                <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span><span style="font-size: 1.1em;font-weight: bold;">지원대상 :</span><br>
                생계ㆍ주거ㆍ의료ㆍ교육 등 복합적 어려움을 가진 위기가정<br>
                <div style="padding-left: 5px;">
                    -기초생활 수급자 및 차상위 가정<Br>
                    -정부 지원기준에 해당되지 못한 저소득 가정<br>
                    -긴급한 지원이 필요한 가정<br>
                    -사회부적응 등 문제해결이 필요한 위기가정<br>
                </div>
                <br><br>
                <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span><span style="font-size: 1.1em;font-weight: bold;">지원내용 :</span><br>
                <div style="padding-left: 5px;">
                    초기 상담 후 대상자로 선정된 가정에게 다양한 복지서비스 제공<br>
                </div>
                <br><br>
                <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span><span style="font-size: 1.1em;font-weight: bold;">신청방법 :</span><br>
                <div style="padding-left: 5px;">
                    -신청절차 : 내방 및 전화 상담 후 안내<Br>
                    -구비서류 : 본인 증빙서류 등 상담 시 안내<br>
                    -문의 : 031-790-2942<br>
                </div>
        </div>
        <div class="a_content">
            <span style="font-size:1.1em;font-weight: bold;">
                ...
                <img src="img/a1_2.jpg" style="width: 100%;">
        </div>
    </div>
    <div id="a_content2">
        <div id="a_content" style="padding-top: 0;
            width: 850px;padding-left: 0;
            ...
            <div class="a_card">
                ...
                <div class="a_boxB">
                    <div class="a_boxBtitle">
                        사례 관리 발굴단
                    </div>
                    <br>
                    <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span>
                    <span style="font-size: 1.1em;font-weight: bold;">사업대상 :</span><br>
                    <div style="padding-left: 30px;">
                        사회복지 전공 대학생 및 졸업생
                        사회복지에 관심 있는 지역주민
                    </div><br>
                    <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span>
                    <span style="font-size: 1.1em;font-weight: bold;">사업내용 :</span><br>
                    <div style="padding-left: 30px;">
                        개입이 필요한 위기가정을 신속하게 발굴하여 연결
                        캠페인 등 홍보활동 진행
                    </div><br>
                    <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span>
            ...
            <div class="a_card">
                ...
                <div class="a_boxB">
                    ...
                    <span style="font-size: 1.1em;font-weight: bold;">사업내용 :</span><br>
                    <div style="padding-left: 30px;">
                        후원자와의 결연을 통해 매월 1회 생계·의료·주거·교육을 위한 후원금 지원
                    </div><br>
                    <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span>
                    <span style="font-size: 1.1em;font-weight: bold;">문의 :</span><br>
                    <div style="padding-left: 30px;">
            ...
            <div class="a_card">
                ...
                <div class="a_boxB">
                    ...
                    <span style="font-size: 1.1em;font-weight: bold;">사업내용 :</span><br>
                    <div style="padding-left: 30px;">
                        경제적 어려움을 겪는 아동·청소년에게 장학금 지원<br>
                        *선정 시부터 고등학교 졸업 시까지
                    </div><br>
                    <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span>
                    <span style="font-size: 1.1em;font-weight: bold;">문의 :</span><br>
            ...
            <div class="a_card">
                <div class="a_box">
                    <div class="a_boximg">
                        <div class="a_boxtext" style="line-height: 40px;">
                            가족탄력성 회복을 위한 ‘힐링캠프’
                        </div>
                        <img src="img/a1_6.png">
                    </div>
                    <div class="a_bt">
                        <a href="#">더 보기</a>
                    </div>
