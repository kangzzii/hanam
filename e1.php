...
<body>
    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                복지관소개<br>
                <span style="font-size:small;">인사말</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
        ...
        <div id="a2_content">
            <div class="e1_box">
                <div class="e1_text">
                    2005년에 설립된 저희 복지관은 하남시에서 처음 만들어진 종합사회복지관으로써<br>
                    그간 아동 , 노인 , 장애인 등 각 분야의 최일선에서 복지를 담당해왔습니다.<br><br>
                    10년을 훌쩍 넘긴 세월 동안 하남시의 복지 환경은 많은 발전을 이루었고<br>
                    복지관의 방향도 다각도로 변화하고 있습니다.<br>
                    하지만 시간과 환경의 변화에도 달라지지 않은 것은<br>
                    복지관의 중심에는 항상 주민들이 있다는 것입니다.<br><Br>
                    주민의 목소리에 귀를 기울이고<br>
                    주민과 함께 성장하는 것<br>
                    이것은 우리가 가장 소중하게 가져온 가치입니다.<br><br>
                    우리는 앞으로 나아갈 미래도 복지관을 사랑하는 사람들과 함께 만들어가려고 합니다.<br>
                    함께 걸어가며 , 감동을 나누며 사람이 중심이 되는 복지를 실천하겠습니다.<br><br>
                    주민의 마음을 잇고 , 행복을 이어 언제나 즐거운 소식을 드리는<br>
                    하남시종합사회복지관이 되겠습니다.</div>
                <div class="e1_img">
                    <img src="img/e1_1.png">
                </div>
            </div>
        </div>
    </div>
