...
<body>
    ...
    <div id="a_content">
        ...
        <div id="a2_content">
            <div class="e6_img">
                <img src="img/c6_1.jpeg">
            </div>
            <ul class="e6_list">
                <li>
                    <div class="e6_box">
                        <img src="img/c6_2.png">
                        <div class="e6_text">
                            기관명<br>
                            하남시종합사회복지관
                        </div>
            ...
            <table class="e6_table">
                ...
                <tr>
                    <td>스포츠실, 취미교실, 피아노교실, 아동교실, 요리교실, 상담실</td>
                    <td>3층</td>
                    <td>고엽제후유증전우회, 사회교육실</td>
                </tr>
                <tr>
                    <td>장애아재활치료교육센터 치료실(1, 2, 3), 특수체육실
                        <br>기획총무팀, 사회복지팀, 사례관리팀</td>
                    <td>2층</td>
                    <td>베트남참전전우회, 정보화교실</td>
                </tr>
                <tr>
                    <td>은방울어린이집, 실버인력뱅크팀, 관장실, 안내데스크</td>
                    <td>1층</td>
                    <td>큰나무지역아동센터</td>
                </tr>
                <tr>
