    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                복지관소개<br>
                <span style="font-size:small;">오시는길</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
       ...
       <div id="a2_content">
           <div style="width: 900px;">
               <!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div id="daumRoughmapContainer1637996187446" class="root_daum_roughmap root_daum_roughmap_landing"></div>
...
<script charset="UTF-8">
	new daum.roughmap.Lander({
		...
		"mapHeight" : "400"
           ...
           <div style="width: 1000px;display: flex;margin-top: 50px;">
               <table class="e8_table">
                   <tr>
                       <td colspan="2">
                            주소 및 연락처
                       </td>
               ...
               <table class="e8_table">
                ...
                <tr>
                    <td>&#2780;</td>
                    <td><a href="https://map.kakao.com/?busStopId=BS264056&amp;from=roughmap" target="_blank">사회복지관</a></td>
                </tr>
                <tr>
                    <td>&#2781;</td>
                    <td><a href="https://map.kakao.com/?busStopId=BS264034&amp;from=roughmap" target="_blank">사회복지관</a></td>
                </tr>
                </table>
            <table class="e8_table">
                <tr>
                ...
                <tr>
                    <td>
                        <img src="img/bus.png" style="width: 280px;">
                    </td>
                </tr>
            </table>
           </div>
