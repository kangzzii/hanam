...
<body>
    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                소통공간<br>
                <span style="font-size:small;">참여자 모집</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
        <div class="a_title">
            참여자 모집 > 추가하기
            <div class="c2_bt" style="float: right;font-size:0.8em;
            line-height:40px;height:40px" onclick="location.href='d3.php'">되돌아가기</div>
        </div>
       <div id="a2_content">
            <div id="d3_wrap">
                <form name="d3frm" enctype="multipart/form-data" method="post" action="d3add_ok.php">
                <table class="d1_addtable">
                    <tr>
                        <th>제목</th>
                        <td><input type="text" class="d1_textbar" 
                            required name="name"
                    ...
                    <tr>
                        <th>모집일</th>
                        <td><input type="date" name="date1"> ~ <input type="date" name="date11"></td>
                    </tr>
                    <tr>
                        <th>활동일</th>
                        <td><input type="date" name="date2"> ~ <input type="date" name="date22"></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td><textarea cols="1000" 
                            required name="content"
                            rows="10" class="textarea" placeholder="내용을 입력하세요"></textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
                            <input type="submit" value="추가하기" class="d1_addbt">
                            <input type="reset" value="다시작성" class="d1_addbt" style="background-color: crimson;">
                        </td>
                    </tr>
                </table>
                </form>
