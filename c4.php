...
<body>
    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                후원ㆍ자원봉사<br>
                <span style="font-size:small;">자원봉사안내</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
        ...
        <div id="a2_content">
            나눔이 주는 특별한 선물, 바로 자원봉사입니다.<br>
            지역사회 곳곳에서 나눔을 실천해주실 자원봉사자를 모집합니다. 사랑을 나누는 활동에 동참해주시기 바랍니다.<br>
            <br><br>
            <img src="img/c4_1.jpeg"style="width:1000px">
            <br><br><br>
            <span style="font-size:1.1em;font-weight: bold;">
                자원봉사 활동 절차
            </span><br><br><br>
            <img src="img/c4_2.png" style="width:1000px">
            <br><br>
            <span style="font-size:1.1em;font-weight: bold;">
                자원봉사 활동내용
            </span><br><br><br>
            <table class="c4_table">
                <tr>
                    <th>청소년 봉사분야</th>
                    <th>성인 봉사분야</th>
                </tr>
            ...
            <span style="color: #6485c0;font-size: 1.5em;font-weight: bold;">・</span><span style="font-size: 1.1em;font-weight: bold;">자원봉사 담당자 : 031-790-2945</span><br>
