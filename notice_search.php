...
<body>
    ...
    <div id="a_content">
        ...
        <div id="a2_content">
            <form class="d1_frm">
                <input type="search" name="search" placeholder="검색어를 입력하세요" class="d1_bar">
                <div class="d1_bt" onclick="search()">
            ...
            <?php
            $search=$_GET["search"];
            $sql="select * from hanam_notice where title like '%$search%' union select * from hanam_notice where content like '%$search%'";
            ...
            ?>
                ...
                <tr>
                    <td>
                        <a href="d1_content.php?no=<?php echo $row["no"]?>">
                             <?php echo $row["no"]?>
                        </a>
                    </td>
                    <td>
            ...
            <?php }?>
                <tr>
                    <td colspan="4">
                        <span style="color:red"><?php echo $total?>건</span>의 데이터가 검색되었습니다.
                    </td>
                </tr>
            </table>
        </div>
