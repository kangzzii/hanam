...
include "include.php";
$no=$_GET["no"];
$sql="select * from hanam_d3 where no=$no";
       ...
       <div id="a2_content">
            <div id="d3_wrap">
                ...
                <table class="d1_addtable">
                    ...
                    <tr>
                        <th>모집일</th>
                        <td><?php echo $row["date1"]?> ~ <?php echo $row["date11"]?></td>
                    </tr>
                    <tr>
                        <th>활동일</th>
                        <td><?php echo $row["date2"]?> ~ <?php echo $row["date22"]?></td>
                    </tr>
                    <tr>
                        <th>첨부파일</th>
                        <td align="center"><?php 
                            ...
                            $fname="../file/".$row["file"];
                            ?>
                        <img src="<?php echo $fname ?>"style="width:500px">
                    </a></td>
                    </tr>
                    <tr>
                        <th>내용</th>
