...
<body>
    ...
    <div id="a_content">
        <div class="a_title">
           ...
           <div class="d1_add" onclick="location.href='d2_add.php'">추가하기</div>
            <?php } }?>
        </div>
        <div id="a2_content">
            <form name="d2_frm" method="post" class="d1_frm">
                <input type="search" name="search" placeholder="검색어를 입력하세요" class="d1_bar">
                <div class="d1_bt" onclick="search2()">
            ...
            ?>
                ...
                <tr>
                    <td>
                        <a href="d2_content.php?no=<?php echo $row["no"]?>">
                             <?php echo $row["no"]?>
                        </a>
                    </td>
                    <td>
