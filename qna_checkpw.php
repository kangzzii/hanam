...
<div id="fixed">
    ...
    <div id="a_content">
       ...
       <div id="a2_content">
           <form name="d5frm" method="post" action="qna_check.php"> 
                ...
                <?php
                $no=$_GET["no"];
                $sql="select * from hanam_qna where no=$no";
                ...
                <input type="hidden" value ="<?php echo nl2br($row["content"])?>" name="content">
                <div style="width:1000px; 
                padding-top:30px; padding-bottom:30px;
                text-align:center;
                border:1px solid lightgray">
                <Br>
                <span style="font-size:2em;font-weight:bold">비밀글보기</span><br>
                이 글은 비밀글입니다. 비밀번호를 입력하여 주세요.<br>
                <br>
                <?php if(isset($_SESSION["id"])){
                    if($_SESSION["id"]=="admin"){
                    ?>
                    <input type="password" name="pw" value="<?php echo $row["pw"]?>" class="d5_text"placeholder="비밀번호를 입력하세요" style="
                width:200px;
                border-bottom:2px solid #00286d; ">
                <?php } } else{?>
                <input type="password" name="pw" required class="d5_text"placeholder="비밀번호를 입력하세요" style="
                width:200px;
                border-bottom:2px solid #00286d; ">
                <?php }?>
                <br><br>
