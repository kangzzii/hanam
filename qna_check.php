...
<div id="fixed">
    ...
    <div id="a_content">
       ...
       <div id="a2_content">
                ...
                if($row["pw"]==$pw){
                ?>
            <form name="d5frm" method="post" action="qnare_write.php"> 
                ...
                <table class="d5_table">
                    ...
                    <tr>
                        ...
                        <td>
                        <?php
                            $sql2="select * from hanam_qnare where p_no=$no";
                            $anser=mysqli_query($conn,$sql2);
                            $an=mysqli_fetch_array($anser);
                            ?>
                            <?php echo $an["name"]?><?php echo $an["content"]?>
                        </td>
                    </tr>
                </table>
                <?php } else{?>
                    비밀번호가 틀렸습니다. 비밀번호를 다시 확인해주세요
                <?php }?> 
                <?php if(isset($_SESSION["id"])){
                    if($_SESSION["id"]=="admin"){
                ?>
                    <input type="submit" class="c2_bt" value="답변하기" style="border:none;float:right;margin-top:30px">
                <?php } }?>
            </form>
       </div>
    </div>
