...
<body>
    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                후원ㆍ자원봉사<br>
                <span style="font-size:small;">홀트패밀리#</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
        ...
        <div id="a2_content">
            <div class="c3_img">
                <img src="img/c3_1.png">
            </div>
            <div style="text-align: center;">
                <br>
                <span style="color:#45bcb4;font-size: 1.2em;">홀트패밀리#</span>은 <span style="color:#ed7987;font-size: 1.2em;">사랑을 행동으로 실천하는 나눔 가족</span>입니다.
                <br>
                뜻 있는 기업이나 단체(중/소 자영업, 프랜차이즈 업체 등)가 매월 일정 금액을 도움이 필요한 아이들을 위해 후원하는<br>
                중소상공인 나눔 실천 캠페인입니다.
            </div>
            <div style="width: 1000px;margin-top: 30px;
            display: flex;">
                <div class="c3_img1">
                    <img src="img/c3_2.png">
                </div>
                <div class="c3_img1">
                    <img src="img/c3_3.png">
                </div>
                <div class="c3_img1">
                    <img src="img/c3_4.png">
                </div>
            </div>
            <br><br>
            ...
            <img src="img/c3_5.png">
            <br><br>
            <span style="font-size:1.1em;font-weight: bold;">
             참여혜택
            </span><br><br>
            <div style="width: 1000px;display: flex;">
                <div class="c3_boxwrap">
                    <div class="c3_circle">
                        <img src="img/c3_6.png">
                    </div>
                   <div class="c3_box">
                    <span style="font-weight: bold;">‘홀트패밀리#’</span><br>
                    현판전달
                    </div>
                </div>
                <div class="c3_boxwrap">
                    <div class="c3_circle">
                        <img src="img/c3_7.png">
                    </div>
                   <div class="c3_box">
                    <span style="font-weight: bold;">기부영수증</span><br>
                    발급
                    </div>
                </div>
                <div class="c3_boxwrap">
                    <div class="c3_circle">
                        <img src="img/c3_8.png">
                    </div>
                   <div class="c3_box">
                       연말<br>
                    <span style="font-weight: bold;">후원 결과 보고</span>
                    </div>
                </div>
                <div class="c3_boxwrap">
                    <div class="c3_circle">
                        <img src="img/c3_9.png">
                    </div>
                   <div class="c3_box">
                    <span style="font-weight: bold;">참여업체 홍보</span><br>
                    (소식지, 홍보채널)
                    </div>
                </div>
            </div>
            ...
            display: flex;
            margin-top: 40px">
            <img src="img/c3_10.png" style="height: 230px;">
            <div style="width: 340px;height: 200px;
            padding-top: 30px;
            font-size: 2em;font-weight: bold;">
            <span style="color:#45bcb4">홀트패밀리#</span>을<br>
            <span style="color: #ed7987;">지도로 보실 수 있습니다.</span>
            <br><br>
                <div class="c3_map">
                    <a href="https://www.google.com/maps/d/u/0/viewer?mid=1bLx6oE6-UyuCHctwpI-GJlmhJRbqWuzA&amp;hl=ko&amp;ll=37.50812104678487%2C127.1807986&amp;z=11" target="_blank">
                    <div style="width: 40px;height: 40px;float: left;margin-left: 20px;"><img src="img/mapicon.png"style="height: 40px;"></div>지도보기</a>
                </div>
            </div>
