...
<body>
    ...
    <div id="space_content_wrap">
        <div class="space_menu">
            <div class="space_title"style="font-size:1.4em">
                복지관소개<br>
                <span style="font-size:small;">법인소개</span>
            </div>
            <ul class="space_list">
    ...
    <div id="a_content">
       ...
       <div id="a2_content">
           <ul class="e3_list">
               <li>
                   <img src="img/e3_1.png"><br>
                   <span style="color: gray;">운영법인</span>
                   <br>사회복지법인 홀트아동복지회
               </li>
               <li>
                <img src="img/e3_2.png"><br>
                <span style="color: gray;">대표자</span>
                <br>홍현국
            </li>
            <li>
                <img src="img/e3_3.png"><br>
                <span style="color: gray;">소재지</span>
                <br>서울특별시 마포구 양화로 19
            </li>
           </ul>
           <br><br>
           <div class="e3_2">
               <span style="font-size: 1.5em;font-weight: bold;">사랑</span>을<span style="font-size: 1.5em;font-weight: bold;">행동</span>으로
               <img src="img/e3_4.jpg">
           </div>
           <div class="e3_3">
            <div class="e3_text">
                하남시종합사회복지관의 운영법인인 홀트아동복지회는<br>
                1955년 미국인 홀트씨 부부가<Br>
                "모든 아동은 가정을 가질 권리가 있다"는<br>
                <br>신념으로 한국 전쟁고아 8명을 입양한 것으로 시작되었습니다.
                60여년이 지난 현재<br>
                홀트아동복지회는 장애인 복지사업, 아동복지사업, 여성복지사업,
                <br>지역복지사업 등 사회 전 영역에서
                <br>사랑을 실천하는 기관으로 역할을 다하고 있습니다.
            </div>
            <div class="e3_img">
                <img src="img/e3_5.png">
            </div>
           </div>
           <br><Br><Br>
           <span style="font-size: 1.2em;font-weight: bold;">
            ...
            <table class="e3_table">
                ...
                <tr>
                    <td>경기지부
                        <br>
                        http://www.kgholt.or.kr
                    </td>
                    <td>☏ 031-217-3292<br>
                        fax 031-217-4764</td>
                    <td>
                        경기도 수원시 팔달구 경수대로 616번길 17-3 (우만동)
                    </td>
                </tr>
                <tr>
                    <td>광주지부
                        <br>
                        http://www.gjholt.or.kr
                    </td>
                    <td>☏ 062-227-8877<br>
                        fax 062-227-3399</td>
                    <td>
                ...
                <tr>
                    <td>고양보호작업장
                        <br>
                        http://www.goyangrehab.or.kr
                    </td>
                    <td>☏ 031-929-1491<br>
                        fax 031-929-1495</td>
                    <td>
                        경기도 고양시 일산서구 탄현로 118-17
                    </td>
                </tr>
            </table>
       </div>
