...
<body>
    ...
    <div id="a_content">
       ...
       <div id="a2_content">
           <form name="d5frm" method="post" action="qnare_writeok.php"> 
                ...
                <table class="d5_table">
                    <tr>
                        <td>글번호</td>
                        <td>
                            <input tpye="text" name="p_no" value="<?php echo $row["no"]?>">
                        </td>
                    </tr>
                    <tr>
                        <td>이름</td>
                    ...
                    <tr>
                        <td>답변</td>
                        <td>
                        <input type="text" name="content" placeholder="답변을 적어주세요" class="d5_text">
                        </td>
                    </tr>
                </table>
